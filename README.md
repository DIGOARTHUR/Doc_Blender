...
> ESSE COMANDO FARÁ UMA EXTRUSÃO DISTANCIANDO OU APROXIMANDO DO CENTRO
   ...
   <li>
  SELECIONANDO UM OBJETIVO POR INTEIRO /  SELECIONA + L
    
> UMA PARTE DO OBJETO É SELECIONADO E O LOGO DEPOIS DO CLIQUE DO (L) O OBJETO É SELECIONADO POR INTEIRO.
  </li>
...
> OS VÉRTICES ADJACENTES SEQUIENCIAS SÃO SELECIONADOS A CADA (+) CLICADO
  </li>
